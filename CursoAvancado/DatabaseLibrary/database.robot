...
Exemplo 02: Executando scripts SQL via STRING
    ...
    ...    INSERT INTO public.account(user_id, username, password, email) VALUES (2, 'Igor Alves', 'robot987', 'robotizando2@robot.com')
    Confere se "Igor Alves" foi inserido com sucesso
...
Limpar Tabela
    ...
    IF    ${REGISTROS} > 0    Delete All Rows From Table    ${TABELA}
